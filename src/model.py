...
class RatingModel:
    ...
    def __init__(
        ...
        if _type is None:
            ...
            if pre_trained_model_json is None:
                raise RatingModel.RatingModelError("pre_trained_model_json is None")
    ...
    def train(
        ...
        pdfs = findDocumentsRecursive('/home/azezal/Downloads/Resume-Rater-master/src/data')
        if pdfs is None:
            raise RatingModel.RatingModelError(
...
if __name__ == "__main__":
    ...
    filename = "train"
    r.train(
        "/home/azezal/Downloads/Resume-Rater-master/src/data/train",
        "fixed",
